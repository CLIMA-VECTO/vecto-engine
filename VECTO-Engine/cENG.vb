...
Public Class cENG
	...
	''' <summary>
	'''     Rotational inertia including flywheel [kgm²]. Saved in input file. Overwritten by generic value in Declaration
	'''     mode.
	''' </summary>
	''' <remarks></remarks>
	...
	''' </summary>
	''' <remarks></remarks>
	Private ReadOnly fMAP As cSubPath
	...
	''' <remarks></remarks>
	Public Property PathFLD(x As Short, Optional ByVal Original As Boolean = False) As String
		Get
			If Original Then
